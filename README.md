...
⦁	The first registered user is assigned the role of Admin. Subsequent users (e.g., User, Manager) are not admins.
For Example:
⦁	Admin can access all features in the Car Management section.
⦁	Other users (like User, Manager) do not have access to CRUD operations.


## Feedback:
⦁	The Country State City API key cannot be obtained at the moment. It may take 1-2 days after approval. Therefore, this API feature has not been implemented yet.
